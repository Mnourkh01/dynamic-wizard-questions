...
export const AGENTS: Record<AgentName, AgentConfig> = {
  ...
  topicPlanner: { model: "haiku", maxOutputTokens: 4000, maxBudgetUsd: 0.5 },
  // Fast single-question generation, schema-constrained. Haiku for low latency:
  // this runs on the hot path between every question.
  questionWriter: { model: "haiku", maxOutputTokens: 2000, maxBudgetUsd: 0.3 },
  ...
  answerGrader: { model: "sonnet", maxOutputTokens: 6000, maxBudgetUsd: 1.0 },
  ...
  reportWriter: { model: "sonnet", maxOutputTokens: 6000, maxBudgetUsd: 0.7 },
  ...
  mcqWriter: { model: "haiku", maxOutputTokens: 8000, maxBudgetUsd: 0.6 },
};
